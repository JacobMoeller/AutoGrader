...
class AssignmentModelTest(TestCase):
    ...
    def test_assignment_description_max_length(self):
        assignment_test = Assignment.objects.get(assignment_id = 1)
        max_length = assignment_test._meta.get_field('assignment_description').max_length
...
class TakesModelTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        Courses.objects.create(course_id = 1, course_title = 'Software Engineering',
                                instructor_username = 'Ryan Murphy')
        Takes.objects.create(student_username = 'matthewsr199', course_id=Courses.objects.get(course_id=1))
